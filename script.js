function compute()
{
	...
	if(principal <= 0 || "")//To show message when user types zero or negative number
    {
    ...
    var year = new Date().getFullYear()+parseInt(years); //Gets actual date and builds on it. 
    ...
    + year + "</span>"; //Result input Amount, Interest rate and No. of years displayed
